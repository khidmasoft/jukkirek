...
@RestController
@RequestMapping("/api/jukkirek-kafka")
public class JukkirekKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JukkirekKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JukkirekKafkaResource(KafkaProperties kafkaProperties) {
